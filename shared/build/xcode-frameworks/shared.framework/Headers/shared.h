...
@class SharedDatabaseDriverFactory, SharedCryptocoin, SharedTrendingCoinGecko, SharedRuntimeQuery<__covariant RowType>, SharedItem, SharedCoin, SharedImage, SharedLinks, SharedPrice, SharedCryptoCoin, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedRuntimeTransacterTransaction, SharedKotlinByteArray, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing, SharedKotlinx_serialization_coreUpdateMode, SharedKotlinByteIterator, SharedKotlinEnum<E>;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TrendingCryptoSDK")))
@interface SharedTrendingCryptoSDK : SharedBase
...
*/
- (void)getTrendingCryptoCoinsWithCompletionHandler:(void (^)(NSArray<SharedCryptocoin *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getTrendingCryptoCoins(completionHandler:)")));
@end;
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)getTrendingCoinsWithCompletionHandler:(void (^)(SharedTrendingCoinGecko * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getTrendingCoins(completionHandler:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinGeckoApi.Companion")))
@interface SharedCoinGeckoApiCompanion : SharedBase
...
@required
- (void)insertCryptocoinId:(NSString *)id symbol:(NSString *)symbol name:(NSString *)name currentPrice:(SharedDouble * _Nullable)currentPrice __attribute__((swift_name("insertCryptocoin(id:symbol:name:currentPrice:)")));
- (void)removeAllCryptoCoins __attribute__((swift_name("removeAllCryptoCoins()")));
- (SharedRuntimeQuery<SharedCryptocoin *> *)selectAllCryptocoins __attribute__((swift_name("selectAllCryptocoins()")));
- (SharedRuntimeQuery<id> *)selectAllCryptocoinsMapper:(id (^)(NSString *, NSString *, NSString *, SharedDouble * _Nullable))mapper __attribute__((swift_name("selectAllCryptocoins(mapper:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Cryptocoin")))
@interface SharedCryptocoin : SharedBase
- (instancetype)initWithId:(NSString *)id symbol:(NSString *)symbol name:(NSString *)name currentPrice:(SharedDouble * _Nullable)currentPrice __attribute__((swift_name("init(id:symbol:name:currentPrice:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
- (SharedDouble * _Nullable)component4 __attribute__((swift_name("component4()")));
- (SharedCryptocoin *)doCopyId:(NSString *)id symbol:(NSString *)symbol name:(NSString *)name currentPrice:(SharedDouble * _Nullable)currentPrice __attribute__((swift_name("doCopy(id:symbol:name:currentPrice:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedDouble * _Nullable currentPrice __attribute__((swift_name("currentPrice")));
...
- (instancetype)initWithItem:(SharedItem *)item __attribute__((swift_name("init(item:)"))) __attribute__((objc_designated_initializer));
- (SharedItem *)component1 __attribute__((swift_name("component1()")));
- (SharedCoin *)doCopyItem:(SharedItem *)item __attribute__((swift_name("doCopy(item:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedItem *item __attribute__((swift_name("item")));
@end;
...
__attribute__((swift_name("CryptoCoin")))
@interface SharedCryptoCoin : SharedBase
- (instancetype)initWithId:(NSString *)id symbol:(NSString *)symbol name:(NSString *)name image:(SharedImage *)image links:(SharedLinks *)links price:(SharedPrice *)price __attribute__((swift_name("init(id:symbol:name:image:links:price:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
- (SharedImage *)component4 __attribute__((swift_name("component4()")));
- (SharedLinks *)component5 __attribute__((swift_name("component5()")));
- (SharedPrice *)component6 __attribute__((swift_name("component6()")));
- (SharedCryptoCoin *)doCopyId:(NSString *)id symbol:(NSString *)symbol name:(NSString *)name image:(SharedImage *)image links:(SharedLinks *)links price:(SharedPrice *)price __attribute__((swift_name("doCopy(id:symbol:name:image:links:price:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *id __attribute__((swift_name("id")));
@property (readonly) SharedImage *image __attribute__((swift_name("image")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CryptoCoin.Companion")))
@interface SharedCryptoCoinCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
- (instancetype)initWithThumbUrl:(NSString * _Nullable)thumbUrl smallUrl:(NSString * _Nullable)smallUrl largeUrl:(NSString * _Nullable)largeUrl __attribute__((swift_name("init(thumbUrl:smallUrl:largeUrl:)"))) __attribute__((objc_designated_initializer));
- (NSString * _Nullable)component1 __attribute__((swift_name("component1()")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()")));
- (SharedImage *)doCopyThumbUrl:(NSString * _Nullable)thumbUrl smallUrl:(NSString * _Nullable)smallUrl largeUrl:(NSString * _Nullable)largeUrl __attribute__((swift_name("doCopy(thumbUrl:smallUrl:largeUrl:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable largeUrl __attribute__((swift_name("largeUrl")));
@property (readonly) NSString * _Nullable smallUrl __attribute__((swift_name("smallUrl")));
@property (readonly) NSString * _Nullable thumbUrl __attribute__((swift_name("thumbUrl")));
@end;
...
- (instancetype)initWithId:(NSString *)id large:(NSString *)large marketCapRank:(int32_t)marketCapRank name:(NSString *)name score:(int32_t)score symbol:(NSString *)symbol thumb:(NSString *)thumb __attribute__((swift_name("init(id:large:marketCapRank:name:score:symbol:thumb:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
...
- (SharedItem *)doCopyId:(NSString *)id large:(NSString *)large marketCapRank:(int32_t)marketCapRank name:(NSString *)name score:(int32_t)score symbol:(NSString *)symbol thumb:(NSString *)thumb __attribute__((swift_name("doCopy(id:large:marketCapRank:name:score:symbol:thumb:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *id __attribute__((swift_name("id")));
@property (readonly) NSString *large __attribute__((swift_name("large")));
@property (readonly) int32_t marketCapRank __attribute__((swift_name("marketCapRank")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
...
@interface SharedItemCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
- (instancetype)initWithHomepageUrl:(NSString * _Nullable)homepageUrl blockchainUrl:(NSString * _Nullable)blockchainUrl twitterUserName:(NSString * _Nullable)twitterUserName subredditUrl:(NSString * _Nullable)subredditUrl githubUrl:(NSString * _Nullable)githubUrl __attribute__((swift_name("init(homepageUrl:blockchainUrl:twitterUserName:subredditUrl:githubUrl:)"))) __attribute__((objc_designated_initializer));
- (NSString * _Nullable)component1 __attribute__((swift_name("component1()")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()")));
- (NSString * _Nullable)component5 __attribute__((swift_name("component5()")));
- (SharedLinks *)doCopyHomepageUrl:(NSString * _Nullable)homepageUrl blockchainUrl:(NSString * _Nullable)blockchainUrl twitterUserName:(NSString * _Nullable)twitterUserName subredditUrl:(NSString * _Nullable)subredditUrl githubUrl:(NSString * _Nullable)githubUrl __attribute__((swift_name("doCopy(homepageUrl:blockchainUrl:twitterUserName:subredditUrl:githubUrl:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable blockchainUrl __attribute__((swift_name("blockchainUrl")));
@property (readonly) NSString * _Nullable githubUrl __attribute__((swift_name("githubUrl")));
@property (readonly) NSString * _Nullable homepageUrl __attribute__((swift_name("homepageUrl")));
@property (readonly) NSString * _Nullable subredditUrl __attribute__((swift_name("subredditUrl")));
...
- (instancetype)initWithCurrentPrice:(double)currentPrice allTimeHigh:(double)allTimeHigh allTimeLow:(double)allTimeLow priceChange24h:(double)priceChange24h priceChangePercentage24h:(double)priceChangePercentage24h marketCap:(double)marketCap totalVolume:(double)totalVolume high24h:(double)high24h low24h:(double)low24h totalSupply:(double)totalSupply circulatingSupply:(double)circulatingSupply lastUpdated:(NSString *)lastUpdated __attribute__((swift_name("init(currentPrice:allTimeHigh:allTimeLow:priceChange24h:priceChangePercentage24h:marketCap:totalVolume:high24h:low24h:totalSupply:circulatingSupply:lastUpdated:)"))) __attribute__((objc_designated_initializer));
...
- (SharedPrice *)doCopyCurrentPrice:(double)currentPrice allTimeHigh:(double)allTimeHigh allTimeLow:(double)allTimeLow priceChange24h:(double)priceChange24h priceChangePercentage24h:(double)priceChangePercentage24h marketCap:(double)marketCap totalVolume:(double)totalVolume high24h:(double)high24h low24h:(double)low24h totalSupply:(double)totalSupply circulatingSupply:(double)circulatingSupply lastUpdated:(NSString *)lastUpdated __attribute__((swift_name("doCopy(currentPrice:allTimeHigh:allTimeLow:priceChange24h:priceChangePercentage24h:marketCap:totalVolume:high24h:low24h:totalSupply:circulatingSupply:lastUpdated:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) double allTimeHigh __attribute__((swift_name("allTimeHigh")));
@property (readonly) double allTimeLow __attribute__((swift_name("allTimeLow")));
@property (readonly) double circulatingSupply __attribute__((swift_name("circulatingSupply")));
@property (readonly) double currentPrice __attribute__((swift_name("currentPrice")));
@property (readonly) double high24h __attribute__((swift_name("high24h")));
@property (readonly) NSString *lastUpdated __attribute__((swift_name("lastUpdated")));
@property (readonly) double low24h __attribute__((swift_name("low24h")));
@property (readonly) double marketCap __attribute__((swift_name("marketCap")));
@property (readonly) double priceChange24h __attribute__((swift_name("priceChange24h")));
@property (readonly) double priceChangePercentage24h __attribute__((swift_name("priceChangePercentage24h")));
@property (readonly) double totalSupply __attribute__((swift_name("totalSupply")));
@property (readonly) double totalVolume __attribute__((swift_name("totalVolume")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TrendingCoinGecko")))
@interface SharedTrendingCoinGecko : SharedBase
- (instancetype)initWithCoins:(NSArray<SharedCoin *> *)coins exchanges:(NSArray<NSString *> *)exchanges __attribute__((swift_name("init(coins:exchanges:)"))) __attribute__((objc_designated_initializer));
- (NSArray<SharedCoin *> *)component1 __attribute__((swift_name("component1()")));
- (NSArray<NSString *> *)component2 __attribute__((swift_name("component2()")));
- (SharedTrendingCoinGecko *)doCopyCoins:(NSArray<SharedCoin *> *)coins exchanges:(NSArray<NSString *> *)exchanges __attribute__((swift_name("doCopy(coins:exchanges:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedCoin *> *coins __attribute__((swift_name("coins")));
@property (readonly) NSArray<NSString *> *exchanges __attribute__((swift_name("exchanges")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TrendingCoinGecko.Companion")))
@interface SharedTrendingCoinGeckoCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
@interface SharedCoin (Extensions)
- (SharedCryptocoin *)toCryptocoin __attribute__((swift_name("toCryptocoin()")));
@end;
